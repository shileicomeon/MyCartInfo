package com.example.bwei.mycartinfo.adapter;
...
import com.example.bwei.mycartinfo.R;
import com.example.bwei.mycartinfo.bean.CartShopBean;
import com.example.bwei.mycartinfo.custom.CustomLinearLayout;
...
public class MyAdapter extends BaseExpandableListAdapter {
    Context context;
    List<CartShopBean.DataBean> group;
    List<List<CartShopBean.DataBean.ListBean>> child;
    private Holder1 holder1;
    private Holder2 holder2;
    public MyAdapter(Context context, List<CartShopBean.DataBean> group, List<List<CartShopBean.DataBean.ListBean>> child) {
          ...
          holder1.checkBox.setChecked(group.get(groupPosition).isgChecked());
             ...
             holder1.checkBox.setOnClickListener(new View.OnClickListener() {
                 ...
                 public void onClick(View v) {
                     ...
                     //拿到你点击孩子的父亲
                     List<CartShopBean.DataBean.ListBean> listBeans = child.get(groupPosition);
                     //遍历看看他有几个孩子
    ...
    public View getChildView(final int groupPosition, final int childPosition, final boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final CartShopBean.DataBean.ListBean listBean = child.get(groupPosition).get(childPosition);
        //设置显示数据
        ...
        //删除事件
           holder2.linearLayout.setOnClickListener(new View.OnClickListener() {
               @Override
               public void onClick(View v) {
                   List<CartShopBean.DataBean.ListBean> list = group.get(groupPosition).getList();
    ...
    public boolean isChildChange(   List<CartShopBean.DataBean.ListBean> listBeans){
        for (int i=0;i<listBeans.size();i++){
